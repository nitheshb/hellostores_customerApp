...
class _$OrderParcelImpl implements OrderParcel {
  ...
  @override
  String toString() {
    return 'ParcelEvent.orderParcel(context: $context, note: $note, usernameTo: $usernameTo, usernameFrom: $usernameFrom, phoneTo: $phoneTo, phoneFrom: $phoneFrom, houseFrom: $houseFrom, houseTo: $houseTo, floorTo: $floorTo, floorFrom: $floorFrom, comment: $comment, value: $value, instruction: $instruction, paymentData: $paymentData, colors: $colors)';
  }
...
abstract class OrderParcel implements ParcelEvent {
  const factory OrderParcel(
      ...
      required final PaymentData paymentData,
      required final CustomColorSet colors}) = _$OrderParcelImpl;
