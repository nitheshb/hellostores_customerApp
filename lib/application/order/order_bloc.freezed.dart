...
class _$CreateOrderImpl implements CreateOrder {
  ...
  @override
  String toString() {
    return 'OrderEvent.createOrder(context: $context, order: $order, payment: $payment, totalPrice: $totalPrice, link: $link, onSuccess: $onSuccess, onFailure: $onFailure)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, context, order, payment,
      totalPrice, link, onSuccess, onFailure);
  ...
  TResult when<TResult extends Object?>({
    ...
    return createOrder(
        context, order, payment, totalPrice, link, onSuccess, onFailure);
  }
...
abstract class CreateOrder implements OrderEvent {
  const factory CreateOrder(
      ...
      required final VoidCallback onFailure}) = _$CreateOrderImpl;
