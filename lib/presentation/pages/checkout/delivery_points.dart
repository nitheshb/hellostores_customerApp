        ...
        list.isNotEmpty
            ? Column(
                children: [
                  ...
                  CustomNetworkImage(
                      url:
                          "https://maps.googleapis.com/maps/api/staticmap?zoom=13&size=300x200&maptype=roadmap&markers=color:red%7C${point.location?.latitude ?? AppHelpers.getInitialLatitude()},${point.location?.longitude ?? AppHelpers.getInitialLongitude()}&key=${AppConstants.googleApiKey}",
                      height: 180.r,
