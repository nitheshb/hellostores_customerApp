      ...
      child: SafeArea(
        child: Padding(
          ...
          child: SizedBox(
            height: 64.r,
            child: CustomButton(
              title: widget.story?[currentIndex]?.productUuid == null
                  ? AppHelpers.getTranslation(TrKeys.viewShop)
                  : AppHelpers.getTranslation(TrKeys.viewProduct),
              onTap: () {
                if (widget.story?[currentIndex]?.productUuid == null) {
                  AppRoute.goShopPage(
                      context: context,
                      shop: ShopData(
                          id: widget.story?.first?.shopId,
                ...
                AppRoute.goProductPage(
                    context: context,
                    product: ProductData(
                        id: widget.story?[currentIndex]?.productId,
                        uuid: widget.story?[currentIndex]?.productUuid));
              },
